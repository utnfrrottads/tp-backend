...
roleRouter.post('/', roleCtrl.createRole); //Si va con un post es un Create
roleRouter.put('/:id', roleCtrl.updateRole); //Si va con un put es un Update al ObjectId especificado
