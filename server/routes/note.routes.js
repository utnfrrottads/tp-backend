...
noteRouter.post('/', noteCtrl.createNote); //Si va con un post es un Create
noteRouter.put('/:id', noteCtrl.updateNote); //Si va con un put es un Update al ObjectId especificado
