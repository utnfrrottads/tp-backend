...
db.articles.insert([
  {
    ...
    price: { value: 75, sinceDate: ISODate('2021-01-01T03:00:00Z') },
  ...
  },
  {
    ...
    price: { value: 250, sinceDate: ISODate('2021-01-01T03:00:00Z') },
    providers: [{ name: 'coto' }, { name: 'jumbo' }],
  ...
  },
  {
    ...
    category: { name: 'general', description: 'Articulos para la liempieza general de la casa' },
    price: { value: 270, sinceDate: ISODate('2021-01-01T03:00:00Z') },
    providers: [{ name: 'coto' }, { name: 'jumbo' }],
